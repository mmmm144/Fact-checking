...
DEFAULT_SOURCE_REPO = "Loctran123/vietnamese-evidence-corpus-chunked"
DEFAULT_OUTPUT_REPO = "Loctran123/vietnamese-evidence-corpus-embeddings-e5-large"
...
def write_shard(
    ...
    texts = [args.prefix + row["text"].strip() for row in rows]
...
- sentence-similarity
- feature-extraction
pretty_name: Vietnamese Evidence Corpus Embeddings (multilingual-e5-large)
---
