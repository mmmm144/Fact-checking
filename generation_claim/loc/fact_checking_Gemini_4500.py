...
# GEMINI_API_KEY_NNN and OPENROUTER_API_KEY are read from the environment/.env.
SCRIPT_DIR = Path(__file__).resolve().parent
PROJECT_ROOT = SCRIPT_DIR.parent
ENV_FILE = PROJECT_ROOT / ".env"
INPUT_FILE = PROJECT_ROOT / "data" / "vie" / "raw" / "viet-fact-checking" / "corpus_v1.json"
OUTPUT_FILE = SCRIPT_DIR / "claims_corpus_v1_gemini_3_5_flash_4500.json"
DEBUG_LOG_FILE = SCRIPT_DIR / "debug_invalid_json_gemini_3_5_flash_4500.log"
FAILED_IDS_FILE = SCRIPT_DIR / "failed_ids_gemini_3_5_flash_4500.json"
MAX_RETRIES = 5
...
DEFAULT_START_INDEX = 4500  # One-based corpus record number
...
def load_gemini_api_key() -> str:
    return load_api_key("GEMINI_API_KEY_NNN")
...
def call_api_with_fallback(user_prompt: str) -> str:
    ...
    raise RuntimeError(
        "No usable API provider. Set GEMINI_API_KEY_NNN and/or OPENROUTER_API_KEY."
    )
...
def main():
    ...
    if not gemini_key and not openrouter_key:
        print(
            "ERROR: Set GEMINI_API_KEY_NNN and/or OPENROUTER_API_KEY "
